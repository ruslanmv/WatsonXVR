...
void SWatsonxVRImageGenItemData::Construct(const FArguments& InArgs)
{
...
TSharedRef<SWidget> SWatsonxVRImageGenItemData::ConstructContent()
{
	...
	return SNew(SVerticalBox)
		...
		[
			...
			.OnClicked(this, &SWatsonxVRImageGenItemData::HandleSaveButton)
			.IsEnabled(this, &SWatsonxVRImageGenItemData::IsSaveEnabled)
		];
}

FReply SWatsonxVRImageGenItemData::HandleSaveButton()
{
	const FString AssetName = FString::FromInt(Texture->GetUniqueID());
	FString TargetFilename = FPaths::Combine(TEXT("/Game/"), UWatsonxVRSettings::Get()->GeneratedImagesDir, AssetName);
...
bool SWatsonxVRImageGenItemData::IsSaveEnabled() const
{
